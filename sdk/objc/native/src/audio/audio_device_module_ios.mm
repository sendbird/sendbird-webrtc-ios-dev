...
AudioDeviceModuleIOS::AudioDeviceModuleIOS(bool bypass_voice_processing, MutedSpeechEventHandler muted_speech_event_handler, ADMErrorHandler error_handler, AudioSourceSink* audioSink)
